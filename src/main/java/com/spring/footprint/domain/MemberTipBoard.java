...
public class MemberTipBoard {
	...
	public MemberTipBoard() {}
    
	public MemberTipBoard(int no, String title, String content, int count, String wDate, String[] img, String orgfilename,
